    ...
    <div className="flex min-h-screen">
      ...
      <main className="flex-1 min-w-0">
        <header className="sticky top-0 z-30 glass-strong border-b border-white/10 px-4 lg:px-8 py-3 flex items-center gap-3">
          <div className="flex items-center gap-2 flex-1 max-w-md glass rounded-lg px-3 py-2">
          ...
          <div className="w-9 h-9 rounded-full bg-gradient-to-br from-primary to-accent grid place-items-center text-xs font-semibold text-primary-foreground">
            AK
          </div>
        </header>
